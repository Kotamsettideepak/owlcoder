<h2><a href="https://www.geeksforgeeks.org/problems/max-sum-without-adjacents2430/1?utm_source=geeksforgeeks&utm_medium=ml_article_practice_tab&utm_campaign=article_practice_tab">Max Sum without Adjacents</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>Arr&nbsp;</strong>of size <strong>N</strong> containing positive integers. Find the <strong>maximum sum </strong>of a any possible <strong>subsequence </strong>such that no two numbers in the <strong>subsequence </strong>should be adjacent in <strong>Arr</strong>. </span></p>
